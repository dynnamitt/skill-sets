...
A library of [Claude Code](https://claude.ai/code) skills — self-contained reference guides loaded into context on activation.
...
```
<skill>/
├── SKILL.md        # Entry point — triggers, principles, inline guidance
